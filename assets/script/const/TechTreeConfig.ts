    ...
    frontend: [
        {
            ...
            milestones: [
                ...
                { id: 'frontend-component-4', requiredBranchLevel: 4, costSkillPoint: 1, title: '微前端联邦', desc: '追加更外侧双重散射，并额外获得子弹 +1', perks: { projectileCount: 1 } },
            ],
        },
        {
            ...
            milestones: [
                ...
                { id: 'frontend-engineering-4', requiredBranchLevel: 4, costSkillPoint: 1, title: '流水线稳态', desc: '攻击 +8，攻击间隔 -0.08 秒', perks: { attack: 8, attackInterval: -0.08 } },
            ],
        },
        {
    ...
    backend: [
        ...
        },
        {
            ...
            milestones: [
                ...
                { id: 'backend-data-4', requiredBranchLevel: 4, costSkillPoint: 1, title: '链路追踪', desc: '投射物额外穿透，且对精英/BOSS再增伤', perks: { penetration: 1, attack: 8 } },
            ],
        },
        {
    ...
    product: [
        {
            ...
            milestones: [
                { id: 'product-insight-2', requiredBranchLevel: 2, costSkillPoint: 1, title: '用户画像', desc: '攻击 +6，回复 8，开启追踪', perks: { attack: 6, heal: 8, trace: true } },
    ...
    project: [
        ...
        },
        {
            ...
            milestones: [
                ...
                { id: 'project-risk-4', requiredBranchLevel: 4, costSkillPoint: 1, title: '预案演练', desc: '维护负担进一步减弱，低血时减伤更强', perks: { defense: 1, maxHp: 14, heal: 14 } },
            ],
        },
        {
    ...
    qa: [
        {
            ...
            milestones: [
                { id: 'qa-automation-2', requiredBranchLevel: 2, costSkillPoint: 1, title: '回归矩阵', desc: '攻击间隔 -0.06 秒，开启追踪', perks: { attackInterval: -0.06, trace: true } },
        ...
        },
        {
            ...
            milestones: [
                ...
                { id: 'qa-gate-4', requiredBranchLevel: 4, costSkillPoint: 1, title: '发布门禁', desc: '弱点射击改为每 3 发一次，且弱点伤害和穿透更高', perks: { penetration: 1, attack: 8 } },
            ],
        },
    ],
    delivery: [
        ...
        },
        {
            ...
            milestones: [
                ...
                { id: 'delivery-support-4', requiredBranchLevel: 4, costSkillPoint: 1, title: '驻场托底', desc: '低血托底增强，击杀回复进一步提高', perks: { defense: 1, maxHp: 14, heal: 14 } },
            ],
        },
    ],
};
