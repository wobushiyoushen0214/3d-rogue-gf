    ...
    static leveles: LevelConfigVo[] = [
        {
            ...
            TechDebtUnlockTime: 120,
            TechDebtSpawnInterval: 65,
            TechDebtScaleMin: 1.2,
            TechDebtScaleMax: 1.55,
            TechDebtHPMultiplier: 2.2,
            TechDebtAttackMultiplier: 1.3,
            TechDebtMoveSpeedMultiplier: 1.2,
            TechDebtAuraInterval: 4,
            TechDebtAuraAttackBonus: 0.08,
            TechDebtAuraMaxStacks: 12,
            CodeReviewUnlockTime: 300,
            CodeReviewInterval: 100,
            CodeReviewMarkCount: 3,
            CodeReviewExpMultiplier: 2,
            CodeReviewMarkDuration: 15,
            ReqChangeUnlockTime: 150,
            ReqChangeSpawnInterval: 72,
            ReqChangeScaleMin: 1.25,
            ReqChangeScaleMax: 1.6,
            ReqChangeHPMultiplier: 2.0,
            ReqChangeAttackMultiplier: 1.8,
            ReqChangeMoveSpeedMultiplier: 1.25,
            ReqChangeZigzagInterval: 1.8,
            ReqChangeZigzagAngle: 55,
            // 技术分享会
            TechShareUnlockTime: 180,
            TechShareInterval: 120,
            TechSharePickupCount: 3,
            TechSharePickupRadius: 8,
            TechShareBuffDuration: 15,
            // ---- 特殊波次 ----
            SpecialWaveUnlockTime: 180,
            SpecialWaveInterval: 75,
            SpecialWaveCountMin: 3,
            SpecialWaveCountMax: 6,
            // 护盾怪
            ShieldEnemyHPMultiplier: 3.0,
            ShieldEnemyAttackMultiplier: 1.2,
            ShieldEnemyMoveSpeedMultiplier: 0.85,
            ShieldEnemyScaleMin: 1.3,
            ShieldEnemyScaleMax: 1.6,
            // 冲锋怪
            ChargeEnemyHPMultiplier: 1.8,
            ChargeEnemyAttackMultiplier: 2.2,
            ChargeEnemyMoveSpeedMultiplier: 1.3,
            ChargeEnemyScaleMin: 1.1,
            ChargeEnemyScaleMax: 1.4,
            ChargeEnemyWindupTime: 1.5,
            ChargeEnemyChargeDuration: 0.6,
            ChargeEnemySpeedMultiplier: 4.0,
            ChargeEnemyStunTime: 1.5,
            ChargeEnemyCooldown: 6.0,
            // 投射怪
            ProjectileEnemyHPMultiplier: 1.5,
            ProjectileEnemyAttackMultiplier: 1.0,
            ProjectileEnemyMoveSpeedMultiplier: 0.9,
            ProjectileEnemyScaleMin: 1.0,
            ProjectileEnemyScaleMax: 1.3,
            ProjectileEnemySlowAmount: 0.3,
            ProjectileEnemySlowDuration: 2.0,
            // 自爆怪
            SelfDestructHPMultiplier: 0.8,
            SelfDestructAttackMultiplier: 3.0,
            SelfDestructMoveSpeedMultiplier: 1.4,
            SelfDestructScaleMin: 0.8,
            SelfDestructScaleMax: 1.1,
            SelfDestructRadius: 3.0,
            SelfDestructFuseTime: 1.5,
            SelfDestructDamageMultiplier: 3.0,
            // ---- 新掉落物 ----
            SnackSpawnInterval: 60,
            SnackHealPercent: 0.08,
            SnackMoveSpeedBonus: 0.5,
            SnackBuffDuration: 5,
            CodeFragmentDropChance: 0.3,
            CertBadgeDropFromBoss: true,
        },
    ];
